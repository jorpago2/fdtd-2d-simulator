...
- Quantitative BIC, chiral/bianisotropic, hyperlens, and negative-index validations still need calibrated references and convergence workflows beyond the reduced browser observables.
