...
- Normal-incidence Fresnel reflectance against the analytic air-dielectric reference; line-port R/T/A now prefers carrier DFT normalization, exposes a finite-window spectral R/T/A estimate, and can apply a stored background reference to S21/S11 when the grid/source/monitor setup is compatible.
...
- Slab-waveguide modal launch metrics: forward guided energy, backward ratio, cladding radiation ratio, core energy fraction, finite-difference mode effective index, mode-port overlap proxies, and finite carrier modal S11/S21 estimates from source-mode projections.
...
- P1 material/device checks: source/radiation routes and phase contracts, conductivity route and late-time attenuation proxy, ADE route plus effective permittivity for Drude/Lorentz/Debye/plasma/ENZ and hyperbolic tensor scenes, anisotropic/gyrotropic tensor-cell diagnostics, six-field bianisotropy passivity and cross-energy diagnostics, interfaces and multilayers (quarter-wave coating, Bragg mirror/stack, total internal reflection, and frustrated TIR), Fabry-Perot cavity localization/standing-wave contrast, ring/add-drop resonator coupling, cylinder/dimer scattering and random-medium spread diagnostics, photonic-crystal/BIC/Fano geometry plus Bloch/leakage diagnostics, SSH/honeycomb/Valley-Hall topology diagnostics, plasmonic/metasurface/absorber/ENZ checks including dipole-fed dimer hot-gap enhancement, SPP interface/grating surface localization, negative-index/superlens bounded observables, nonlinear/harmonic/phase-change active-media observables, time-varying/Floquet media geometry, reflected sidebands, phase coherence, and active-region overlap, and coupled/non-Hermitian workflow diagnostics for PT/near-EP, biased gain/loss SSH chains, Kerr/ENZ PhC defects, Janus/Huygens sources, and Valley-Hall temporal scenes.
...
P1 entries include both executable scene-family checks and tracking entries for known quantitative gaps. Executable P1 examples currently cover source/radiation routing, polarization, array phase, slot/PEC/substrate, and NTFF diagnostics; single/double-slit diffraction; conductivity and ADE/tensor material behavior; interfaces and multilayers; Fabry-Perot/ring resonator behavior; scattering/disorder scenes; photonic-crystal/BIC/Fano bounded observables; SSH/honeycomb/Valley-Hall topology diagnostics; plasmonic/metasurface/absorber/ENZ checks; SPP interface/grating localization; negative-index/superlens bounded observables; nonlinear/active-media overlap, harmonic, sideband, switching, and limiter diagnostics; time-varying/Floquet media checks for uniform, traveling, and staggered modulation; and coupled/non-Hermitian workflow checks. Tracking-only P1 entries remain for analytic source-pattern regression, monitor/observable sweeps, calibrated nonlinear material transfer curves, coupled-workflow references beyond current diagnostics, Floquet de-embedding, hyperlens MTF calibration, and calibrated six-field bianisotropy references.
...
- The interface, multilayer, and resonator P1 checks verify geometry, finite energy localization, monitor samples, and qualitative coupling. Reference-normalized R/T/A can remove background line-port response, but it does not replace transfer-matrix spectra, calibrated de-embedded S-parameters, Q extraction, or mesh-convergence studies.
...
- The plasmonic/metamaterial P1 checks verify Drude masks, localized plasmon overlap, dipole-fed dimer hot-gap source/polarization/gap-resolution contracts, metasurface bar gradients, lossy absorber backplanes, hyperbolic annular-transfer MTF samples, and ENZ slab overlap. The dimer check now requires measurable `|E|^2` enhancement over a local background, but it still does not replace a resonance spectrum, source-normalized enhancement calibration, absorber S-parameter retrieval, full hyperlens imaging metrics, or mesh convergence.
...
- The browser physics runner reports finite-scene port transmittance and runtime Brewster-scan minima as diagnostics. Blocking checks use observables that are meaningful for the finite scene: Fresnel R, low R at the analytic Brewster angle, PML residual energy, slab modal launch and mode overlap, ringdown Q, and source-retirement stability.
...
- The time-varying/Floquet P1 checks verify modulated masks, active-cell counts, finite reflected-sideband diagnostics, uniform versus traveling or staggered modulation phase coherence, and field overlap with slabs, guides, rings, or resonator chains. They do not replace calibrated de-embedded multi-incidence scattering matrices, sideband power-balance closure, reverse-port isolation spectra, or mesh convergence.
- The coupled/non-Hermitian P1 checks verify gain/loss masks, PT and near-EP modal diagnostics, biased SSH edge/localization diagnostics, Kerr/ENZ PhC defect overlap, Janus/Huygens source routing, and Valley-Hall temporal/Floquet observables. They do not replace eigenmode coalescence calculations, non-Bloch spectra, calibrated isolation/transport spectra, protected-transport spectra, or device-level S-parameter validation.
- Quantitative BIC/topological, optical-activity/tensor-parameter, hyperlens, and negative-index validations still need calibrated references and convergence workflows beyond the browser diagnostics.
