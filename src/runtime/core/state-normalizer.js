(function initFdtdStateNormalizer(global) {
  "use strict";
  ...
  function createStateNormalizer(dependencies) {
    ...
    const visualLayerStateKeys = requireObject(dependencies.visualLayerStateKeys, "visualLayerStateKeys");
    const materialNames = requireObject(dependencies.materialNames, "materialNames");
    const defaultMonitorConfig = requireObject(dependencies.defaultMonitorConfig, "defaultMonitorConfig");
    ...
    const knownPresetValue = requireFunction(dependencies.knownPresetValue, "knownPresetValue");
  ...
  global.FdtdStateNormalizer = Object.freeze({
