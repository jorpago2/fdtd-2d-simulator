    ...
    modePortAnalysisEstimate() {
      ...
      const sParameters = this.modePortDftSummary?.valid
        ? {
            ...
            inputPower: this.modePortDftSummary.inputPower,
            reflectedPower: complexPower(this.modePortDftSummary.reflectedPhasor),
            transmittedPower: complexPower(this.modePortDftSummary.transmittedPhasor),
