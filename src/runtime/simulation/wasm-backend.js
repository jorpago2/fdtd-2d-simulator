...
Object.assign(globalThis, {
  WASM_FEATURE_CONDUCTIVITY,
  WASM_FEATURE_KERR,
  WASM_FEATURE_SATURABLE_GAIN,
  WASM_FEATURE_TENSOR_GYRO,
  WASM_FEATURE_TFSF,
  WASM_FEATURE_CPML,
  WASM_FEATURE_MODE_SOURCE,
  WASM_FEATURE_ELECTRIC_ADE,
  WASM_FEATURE_MAGNETIC_ADE,
  WASM_FEATURE_MODULATION,
  WASM_FEATURE_HARMONIC,
  WASM_FEATURE_PHASE_CHANGE,
  WASM_FEATURE_BIANISOTROPY,
  WASM_STEP_KERR,
  WASM_STEP_SATURABLE_GAIN,
  WASM_STEP_TENSOR_GYRO,
  WASM_STEP_ELECTRIC_ADE,
  WASM_STEP_MAGNETIC_ADE,
  WASM_STEP_MODULATION,
  WASM_MAX_TFSF_SOURCES,
  WASM_TFSF_STRIDE,
  WASM_TFSF_SOURCE_TYPE,
  WASM_MAX_MODE_SOURCES,
  WASM_MODE_SOURCE_STRIDE,
  WASM_LAYOUT_GROUP_DYNAMIC_MATERIAL,
  WASM_LAYOUT_GROUP_TENSOR_GYRO,
  WASM_LAYOUT_GROUP_ELECTRIC_ADE,
  WASM_LAYOUT_GROUP_MAGNETIC_ADE,
  WASM_LAYOUT_GROUP_PHASE_CHANGE,
  WASM_LAYOUT_GROUP_HARMONIC,
  WASM_LAYOUT_GROUP_BIANISOTROPY,
  WASM_LAYOUT_GROUP_FULL_VECTOR_BIANISOTROPY,
  WASM_STEP_FIELD_OFFSET_NAMES,
  WASM_STEP_RUNTIME_PARAMETER_NAMES,
  WASM_STEP_SOURCE_OFFSET_NAMES,
  WASM_STEP_ARGUMENT_NAMES,
  WASM_LAYOUT_GROUP_LABELS,
  wasmAlign4,
  wasmAlign8,
  WasmFdtdBackend,
});
