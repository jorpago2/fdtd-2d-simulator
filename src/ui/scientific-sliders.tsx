...
const definitions: ScientificSliderDefinition[] = [
  { mountId: "reactFrequencySliderRoot", controlId: "frequencyInput", initial: { labelText: "Source wavelength λₛ / λ₀", min: 0.25, max: 5, step: 0.01, value: 1, disabled: false } },
  { mountId: "reactAmplitudeSliderRoot", controlId: "amplitudeInput", labelId: "sourceAmplitudeLabel", initial: { labelText: "Source amplitude Jz,₀", min: 0.05, max: 1.2, step: 0.05, value: 0.55, disabled: false } },
  ...
  { mountId: "reactSourceAngleSliderRoot", controlId: "sourceAngleInput", initial: { labelText: "Source axis θ (°)", min: 0, max: 360, step: 1, value: 0, disabled: true } },
  ...
  { mountId: "reactMonitorLengthSliderRoot", controlId: "monitorLengthInput", initial: { labelText: "Monitor length / λ₀", min: 0.1, max: 8, step: 0.05, value: 2, disabled: false } },
  { mountId: "reactMonitorAngleSliderRoot", controlId: "monitorAngleInput", initial: { labelText: "Monitor angle θ (°)", min: 0, max: 180, step: 1, value: 90, disabled: false } },
  { mountId: "reactBrushSizeSliderRoot", controlId: "brushMenuSizeInput", initial: { labelText: "Brush size / λ₀", min: 0.05, max: 0.8, step: 0.05, value: 0.2, disabled: false } },
  ...
  { mountId: "reactGainSliderRoot", controlId: "gainInput", initial: { labelText: "Display gain (×)", min: 0.2, max: 2.6, step: 0.05, value: 1, disabled: false } },
];
...
function ScientificSlider({ definition }: { definition: ScientificSliderDefinition }) {
  ...
  const commitExactValue = (value: string | number) => {
    ...
    update({ value: Math.min(current.max, Math.max(current.min, nextValue)) });
  ...
  return (
    <Slider
      ...
      onBlur={({ value }) => commitExactValue(value)}
      onInputKeyUp={(event) => {
